          ...
          busboy.on('file', (fieldname, file, filename, encoding, mimetype) => {
            ...
            if (!$seen && fieldname === $key) {
              ...
              if (expectedMimeType) {
                 ...
                 */
                if (expectedMimeType instanceof RegExp &&
                    expectedMimeType.test(mimetype)) {
                  mimeTypeIsValid = true;
                } else if (typeof expectedMimeType === 'string' &&
      ...
      return new Promise((resolve, reject) => {
        ...
        try {
          ...
          busboy.on('file', (fieldname, file, filename, encoding, mimetype) => {
            ...
            // if seen and fieldname matches the field we are looking for.
            if ((fieldname === $key ||
                (keyIsArray && $key.includes(fieldname))) && filename) {
              // Set default data attributes.
              $data = {
              ...
              if (Object.keys($opts.mimeTypeForEachField).length &&
              ...
              if (Object.keys($opts.extensionsForEachField).length &&
